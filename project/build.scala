...
object BuildSettings extends Build {
  ...
  val baselist = Vector("chisel", "uncore", "rocket", "hardfloat", "bridge")
  def getsubdirs = {
  ...
  lazy val lowrisc_chip = Project("lowrisc_chip", file("."), settings = buildSettings ++ chipSettings).dependsOn(chisel, uncore, rocket, addons)
